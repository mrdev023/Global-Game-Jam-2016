...
public class Boutons {
	private GImage bouton;	// la GImage du bouton qui est affiche sur l'ecran
	private Image boutonSurvole, boutonNormal;	// les differentes textures du bouton
	...
	public Boutons(String nomImage, int x ,int y, String texteP, String police, Color couleurTxt, Dimension dimP){	// constructeur du bouton
		...
		boutonSurvole = new GImage("Ressources Editeur/HUD/Boutons/" + nomImage + "_survole.png").getImage();
	...
	public boolean hitBox(int x,int y){	// methode qui renvoie vrai si la sourie est sur le bouton ( pour le clic par exemple )

package Input;
/*
 * Cette classe sert a recuperer les actions de la souris et a declancher le timer qui lui correspond.
 * Ce timer est ensuite utilise dans la classe Jeu de la meme maniere qu'un " public void mouseClicked(MouseEvent e) "
 */
